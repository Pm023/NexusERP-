...
try:
    ...
    print(f"[!] Database setup skipped - check database.py (Error: {e})")

# Initialize FastAPI
app = FastAPI(
    title="NexusERP - Enterprise Suite",
    description="NexusERP - Unified Enterprise Portal with Google Drive Integration",
    version="1.0.0"
)
...
if __name__ == "__main__":
    print("=" * 70)
    print("  NEXUSERP - ENTERPRISE SUITE")
    print("=" * 70)
    print("\n  Server URLs:")
    print("   Frontend: http://127.0.0.1:8001")
    print("   Login:    http://127.0.0.1:8001/static/index.html")
