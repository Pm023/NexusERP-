...
def generate_proforma_pdf(payload: ProformaPayload):
    buffer = io.BytesIO()
    ...
    def draw_header(canv):
        ...
        canv.drawString(margin, height - 40, "NEXUS EXIM")
        canv.drawString(margin, height - 58, "GLOBAL SOLUTIONS")
        
        canv.setFont("Helvetica", 9)
        canv.setFillColor(colors.black)
        canv.drawRightString(width - margin, height - 40, "Suite 404, Trade Centre, Sector 62,")
        canv.drawRightString(width - margin, height - 52, "Noida, UP, India-201301.")
        canv.drawRightString(width - margin, height - 64, "https://nexusexim.io")
        canv.drawRightString(width - margin, height - 76, "sales@nexusexim.io")
    ...
    c.drawString(margin, current_y, "For NEXUS EXIM GLOBAL SOLUTIONS")
    current_y -= 40
    c.setFont("Helvetica", 10)
    c.drawString(margin, current_y, "Authorized Signatory")
    current_y -= 12
    c.drawString(margin, current_y, "Vikram Sharma")
    current_y -= 12
